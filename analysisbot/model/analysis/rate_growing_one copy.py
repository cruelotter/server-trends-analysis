...
def chunking(sources, token, end_date:datetime, history:int, remerge:bool=False, mcdm:bool=True):
    """chunking _summary_
...
if __name__=="__main__":
    ...
    df  = calc_meams_df(sources, token, start_date, 12,remerge=True, mcdm=True)
