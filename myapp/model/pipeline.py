...
from myapp.model.parsers.parserfactory import ParserFactory
from myapp.model.analysis.preprocessing import Preprocessing
...
'''               
    ...
    ''' def create_pdf(self, top: np.ndarray, data: pd.DataFrame):
            ...
            height = 279.4
            pdf = FPDF()
            pdf.add_font('"Sans', '', 'myapp/model/fonts/NotoSans-Regular.ttf', uni=True)
